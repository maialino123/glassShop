...
(function($) {
    ...
    // svg fallback
    if (!Modernizr.svg) {
        $(".header__logo img").attr("src", "logo.png"/*tpa=https://preview.colorlib.com/theme/philosophy/js/images/logo.png*/);
    }
    ...
    * ------------------------------------------------------ */
	...
	var clGoogleMap = function() { 
        ...
        if (typeof google === 'object' && typeof google.maps === 'object') {
            ...
            // marker url
            if ( winWidth > 480 ) {
                marker_url = 'icon-location@2x.png'/*tpa=https://preview.colorlib.com/theme/philosophy/js/images/icon-location@2x.png*/;
            } else {
                marker_url = 'icon-location.png'/*tpa=https://preview.colorlib.com/theme/philosophy/js/images/icon-location.png*/;
            }
            ...
            var style = [ 
                ...
                { 	
                    ...
                    elementType: "https://preview.colorlib.com/theme/philosophy/js/labels.icon",
                    stylers: [
                        { visibility: "off" } 
                    ] 
                },
                ...
                { 
                    featureType: "transit", 
                    elementType: "https://preview.colorlib.com/theme/philosophy/js/geometry.fill", 
                    stylers: [
                        { hue: main_color },
                        { visibility: "on" }, 
